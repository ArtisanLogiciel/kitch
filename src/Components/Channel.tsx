...
export default function Channel({ userLogin }: UserLoginProps) {
  // Pk je px pas mettre string ???
  ...
  if (dataUser) {
    console.log(
      "---------Info sur le USER avec le user_login passé en PROPS :-----------",
      userLogin
    );
        ...
        <div>
          ...
          <div className="flex justify-between mt-2 ">
            <div className="flex">
              ...
              />
              <div>
                <Link href={`/${dataUser[0].display_name}`} className="font-bold">
                  {dataUser[0].display_name}
                </Link>
                ...
                <div className="flex items-center">
                  ...
                  <div className="text-[#5f5f5f] text-sm hidden md:flex">
                    {dataChannel[0].tags.map((tag, index) => (
                      <p key={index} className=" bg-[#e6e6e6] rounded-full px-2 m-2">
                        {tag}
                      </p>
                    ))}
                  </div>
              ...
              <div className="flex">
                {dataFollowers ? (
                  ...
                  <p>
                    ...
                    <span className="text-[#53535f]">followers</span>
                  </p>
                ) : null}
                {dataTeams ? (
                  <div className="flex">
                    <BsDot />
                    {dataTeams ? <p className=" font-bold">{teamName}</p> : null}
                  </div>
                ) : null}
              </div>
